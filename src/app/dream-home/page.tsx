...
export const metadata: Metadata = {
  title: "My Dream House 🏔️ | Ayaz's Project",
  description: "A look into Ayaz's dream house in the mountains - small, peaceful, and comfortable.",
};
